class CreateRbWeeklyStats < ActiveRecord::Migration[8.0]
  def change
    create_table :rb_weekly_stats do |t|
    ...
    add_index :rb_weekly_stats, [:player_id, :season, :week], unique: true
    add_index :rb_weekly_stats, [:season, :week]
    add_index :rb_weekly_stats, :team_abbr
  end
end
